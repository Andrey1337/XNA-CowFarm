...
{
    //public delegate void ContactHandler(CollideEventArg arg);
    public class ContactManager
    {
        ...
        public event EventHandler<CollideEventArg> Contacted;
        public event EventHandler<NearbyEventArg> Nearby;
        ...
        private void AddPair(ref FixtureProxy proxyA, ref FixtureProxy proxyB)
        {
            ...
            if (_dictionary.ContainsKey(bodyA.BodyId))
                _dictionary[bodyA.BodyId].Add(bodyB);
            else
                _dictionary.Add(bodyA.BodyId, new HashSet<Body>() { bodyB });


            if (_dictionary.ContainsKey(bodyB.BodyId))
                _dictionary[bodyB.BodyId].Add(bodyA);
            else
                _dictionary.Add(bodyB.BodyId, new HashSet<Body>() { bodyA });
        ...
        private Dictionary<int, HashSet<Body>> _dictionary;
        ...
        {
            Dictionary<int, HashSet<Body>> dictionary = new Dictionary<int, HashSet<Body>>();
            HashSet<Contact> setOfContacts = null;
            ...
            for (int i = 0; i < ContactList.Count; i++)
            {
                ...
                c.SetContactManager(this);
                c.MyUpdate(this, dictionary);

            }
            Contacted?.Invoke(this, new CollideEventArg(dictionary));
        ...
        public void ContactUpdate(CollideEventArg contact)
        {

            Contacted?.Invoke(this, contact);
        }
