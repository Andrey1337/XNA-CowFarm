...
{
    public class SimpleDemo1 : PhysicsGameScreen, IDemoScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            _rectangle = BodyFactory.CreateRectangle(World, 5f, 5f, 1000f);

            _rectangle.BodyType = BodyType.Dynamic;
            _rectangle.Restitution = 1f;
            
           

            SetUserAgent(_rectangle, 100, 0);
