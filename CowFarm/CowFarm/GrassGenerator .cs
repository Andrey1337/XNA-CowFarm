...
namespace CowFarm
{
    public class GrassGenerator : IGenerator
    {
        ...
        public GrassGenerator(GraphicsDeviceManager graphics, AnimatedSprites grassMovement)
        {
        ...
        public void Generate(World world)
        {
            ...
            var y = _random.Next(0, _graphics.PreferredBackBufferHeight - _grassMovement.Animation.Height);

            var grass = new Grass(_graphics, new Rectangle(x, y, _grassWidth, _grassMovement.Animation.Height), _grassMovement);
