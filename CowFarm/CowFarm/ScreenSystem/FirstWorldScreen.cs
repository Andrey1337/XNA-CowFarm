...
namespace CowFarm.ScreenSystem
{
    ...
    {
        public FirstWorldScreen(ContentManager contentManager, GraphicsDeviceManager graphics,
        ...
        {
            Cow = new Cow(World, Graphics, new Rectangle(100, 100, 54, 49), new AnimatedSprites(GameTextures["cowRightWalk"], 3, 54, 16), new AnimatedSprites(GameTextures["cowRightWalk"], 3, 54, 16), new AnimatedSprites(GameTextures["cowLeftWalk"], 3, 54, 16), new AnimatedSprites(GameTextures["cowUpWalk"], 3, 54, 16), new AnimatedSprites(GameTextures["cowDownWalk"], 3, 54, 16));
        }
