...
namespace CowFarm.ScreenSystem
{
    ...
    public sealed class MenuEntry
    {
        ...
        /// </summary>
        public MenuEntry(MenuScreen menu, string text, EntryType type, CowFarm.ScreenSystem.GameScreen screen)
        {
            Text = text;
            Screen = screen;
            _type = type;
        ...
        public CowFarm.ScreenSystem.GameScreen Screen { get; private set; }
