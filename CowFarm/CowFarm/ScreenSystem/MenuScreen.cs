...
namespace CowFarm.ScreenSystem
{
    ...
    /// </summary>
    public class MenuScreen : CowFarm.ScreenSystem.GameScreen
    {
#if WINDOWS || XBOX
...
#endif
        private List<CowFarm.ScreenSystem.MenuEntry> _menuEntries = new List<CowFarm.ScreenSystem.MenuEntry>();
        ...
        private CowFarm.ScreenSystem.MenuButton _scrollUp;
        private CowFarm.ScreenSystem.MenuButton _scrollDown;
        private CowFarm.ScreenSystem.MenuButton _scrollSlider;
        ...
        public void AddMenuItem(string name, CowFarm.ScreenSystem.EntryType type, CowFarm.ScreenSystem.GameScreen screen)
        {
            CowFarm.ScreenSystem.MenuEntry entry = new CowFarm.ScreenSystem.MenuEntry(this, name, type, screen);
        ...
        public override void LoadContent()
        {
            ...
            _scrollUp = new CowFarm.ScreenSystem.MenuButton(_texScrollButton, false, new Vector2(scrollBarPos, _menuBorderTop - _texScrollButton.Height), this);
            _scrollDown = new CowFarm.ScreenSystem.MenuButton(_texScrollButton, true, new Vector2(scrollBarPos, _menuBorderBottom + _texScrollButton.Height), this);
            _scrollSlider = new CowFarm.ScreenSystem.MenuButton(_texSlider, false, new Vector2(scrollBarPos, _menuBorderTop), this);
        ...
        {
            int index = 0;
            foreach (CowFarm.ScreenSystem.MenuEntry entry in _menuEntries)
            {
        ...
        public override void HandleInput(CowFarm.ScreenSystem.InputHelper input, GameTime gameTime)
        {
            ...
            if (input.IsMenuSelect() && _selectedEntry != -1)
            {
                ...
                else if (_menuEntries[_selectedEntry].Screen != null)
                {
                    ...
                    if (_menuEntries[_selectedEntry].Screen is CowFarm.ScreenSystem.IDemoScreen)
                        ScreenManager.AddScreen(new MessageBoxScreen((_menuEntries[_selectedEntry].Screen as CowFarm.ScreenSystem.IDemoScreen).GetDetails()));
                }
            }
        ...
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            for (int i = 0; i < _menuEntries.Count; ++i)
            {
                ...
                if (ScreenState == CowFarm.ScreenSystem.ScreenState.TransitionOn)
