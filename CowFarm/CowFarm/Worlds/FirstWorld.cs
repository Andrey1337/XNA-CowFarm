...
namespace CowFarm.Worlds
{
    public class FirstWorld : World
    {
            ...
            : base(graphics, gameTextures, screenManager, gameStartedTime)
        {
            ...
            new GreenTree(this, graphics, new Rectangle(644, 164, 155, 261), gameTextures);
            new GreenTree(this, graphics, new Rectangle(437, 5, 155, 261), gameTextures);
            new GreenTree(this, graphics, new Rectangle(1000, 550, 155, 261), gameTextures);
            new GreenTree(this, graphics, new Rectangle(150, 450, 155, 261), gameTextures);
            new GreenTree(this, graphics, new Rectangle(900, 55, 155, 261), gameTextures);
