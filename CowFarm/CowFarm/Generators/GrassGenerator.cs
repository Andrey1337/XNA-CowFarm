...
namespace CowFarm.Generators
{
    public class GrassGenerator : Generator
    {
        ...
        public GrassGenerator(GraphicsDeviceManager graphics, AnimatedSprites animatedSprites, int objectsMaxCounter, DateTime gameStartedTime) :
        ...
        {
            if (_grassSpawnTime - currentTime < TimeSpan.FromMilliseconds(0) && ObjectsCounter <= ObjectsMaxCounter)
            {
